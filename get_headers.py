...
def get_request_headers():
    ...
    if input('是否需要添加证书(推荐,减少ssl安全问题|需要管理员权限):(Y/n)').lower() == 'y':
    ...
    while True:
        ...
        if currentPageUrl == 'https://www.smartedu.cn/': # 登陆成功后跳转
            print('登录成功')
            break
    driver.get('https://basic.smartedu.cn/tchMaterial/detail?contentType=assets_document&contentId=b8e9a3fe-dae7-49c0-86cb-d146f883fd8e&catalogType=tchMaterial&subCatalog=tchMaterial')
